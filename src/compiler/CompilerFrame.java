...
public class CompilerFrame extends JFrame{
	...
	public CompilerFrame(String title) {
		...
		// 文件保存和打开对话框
				...
				JLabel editLabel = new JLabel("|LARCH程序文本编辑区");
...
//内部类：监听鼠标右键
	...
	// 运行：分析并运行LARCH程序，显示运行结果
		...
		private void create(String filename) {
			if (filename == null) {
				filename = JOptionPane.showInputDialog("请输入新建文件的名字.(后缀名为.lsl)");
	...
	public static void main(String[] args) {
		...
		CompilerFrame frame = new CompilerFrame("LARCH解释器");
		System.out.println("111111");
